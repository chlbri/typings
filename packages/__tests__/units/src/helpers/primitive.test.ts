...
describe('Helper: primitive', () => {
  ...
  describe('#01 => primitive.string()', () => {
    const result = type(({ primitive }) => ({ value: primitive.string() }));
  ...
  describe('#02 => primitive.string("hello")', () => {
    const result = type(({ primitive }) => ({ value: primitive.string('hello') }));
  ...
  describe('#03 => primitive.number()', () => {
    const result = type(({ primitive }) => ({ value: primitive.number() }));
  ...
  describe('#04 => primitive.number(42)', () => {
    const result = type(({ primitive }) => ({ value: primitive.number(42) }));

    test('#01 => value matches', () => expect(result.type).toEqual({ value: 42 }));
  });

  describe('#05 => primitive.boolean()', () => {
    const result = type(({ primitive }) => ({ value: primitive.boolean() }));
  ...
  describe('#06 => primitive.boolean(true)', () => {
    const result = type(({ primitive }) => ({ flag: primitive.boolean(true) }));

    test('#01 => value matches', () => expect(result.type).toEqual({ flag: true }));
  });

  describe('#07 => primitive.symbol()', () => {
    const result = type(({ primitive }) => ({ value: primitive.symbol() }));
  ...
  describe('#10 => primitive.undefined', () => {
    const result = type(({ primitive }) => ({ value: primitive.undefined }));
  ...
  describe('#11 => primitive.bigint()', () => {
    const result = type(({ primitive }) => ({ value: primitive.bigint() }));
