import type { JSON_Primitive, Primitive, PrimitiveObject } from '@bemedev/typings';

describe('types: types.types', () => {
  const not1 = { data: 'dodo', date: new Date(), num: 4 };
  ...
  const nested = { user: { name: 'Bob', age: 25 }, tags: ['admin', 'editor'] };
