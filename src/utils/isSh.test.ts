...
describe('isSh', () => {
  ...
  describe('#02 => with non-object values', () => {
    ...
    test('#02 => number returns false', () =>
      expect(isSh(42)).toBe(false));

    test('#03 => boolean returns false', () =>
      expect(isSh(true)).toBe(false));

    test('#04 => undefined returns false', () =>
      expect(isSh(undefined)).toBe(false));

    test('#05 => null returns false', () =>
      expect(isSh(null)).toBe(false));
